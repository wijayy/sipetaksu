<header class="fixed top-0 left-0 z-50 w-full text-white bg-mine-100" x-data="{ open: false }">
            ...
            <div class="flow-root mt-6">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="py-6 space-y-2">
                        <div class="-mx-3">
                            <a href="#"
                                class="block px-3 py-2 -mx-3 font-semibold rounded-lg hover:text-black text-base/7 hover:bg-gray-50">Features</a>
                            <a href="#"
                                class="block px-3 py-2 -mx-3 font-semibold rounded-lg hover:text-black text-base/7 hover:bg-gray-50">Marketplace</a>
                            <a href="#"
                                class="block px-3 py-2 -mx-3 font-semibold rounded-lg hover:text-black text-base/7 hover:bg-gray-50">Company</a>
                        </div>
                        <div class="py-6">
                            <a href="#"
